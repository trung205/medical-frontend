...
export function FeaturedBlogs({blogs, title, description, handleShowBlogs, className, titleClassName}: any) {
    ...
    <section className={`py-20 ${className || ""}`}>
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className={`text-3xl lg:text-4xl font-bold mb-4 text-balance ${titleClassName || ""}`}>
        ...
        <div className="text-center mt-12">
          <Button variant="outline" size="lg" onClick={handleShowBlogs}>
            Xem tất cả bài viết
          </Button>
        </div>
      </div>
