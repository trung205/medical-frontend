...
const mockProductData: Record<string, any> = {
  "1": {
    ...
    slug: "may-sieu-am-4d-ge-voluson-e10",
    sku: "US-GE-V10",
    price: 2500000000,
    ...
    description: "<p>Máy siêu âm 4D cao cấp từ GE Healthcare</p>",
  },
}
...
export default function EditProductPage() {
  ...
  useEffect(() => {
    if (productData) {
      ...
      setLevel2Categories(mockCategoriesLevel2[productData.category1] || [])
      setLevel3Categories(mockCategoriesLevel3[productData.category2] || [])
    }
  }, [productData, form])

  const onSubmit = (data: ProductFormData) => {
    console.log("[v0] Updated product data:", data)
